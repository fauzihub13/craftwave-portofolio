                            ...
                            <div class="col-lg-9">
                                <div class="single-page pr-30 mb-lg-0 mb-sm-5">
                                    ...
                                    <div class="single-content mb-50">
                                        ...
                                        <h4>Contact Us</h4>
                                        <p>If you have any questions about these Terms, please <a href="{{ route('agrihub.page-contact') }}">contact us</a>.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 primary-sidebar sticky-sidebar">
                                <div class="widget-area">
                                    ...
                                    <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                                        ...
                                        <div class="single-post clearfix">
                                            <div class="image">
                                                <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/thumbnail-6.jpg') }}" alt="#" />
                                            </div>
                                            <div class="content pt-10">
                                                <h6><a href="{{ route('agrihub.shop-product-detail') }}">Lorem, ipsum</a></h6>
                                                <p class="price mb-0 mt-5">$25</p>
                                                <div class="product-rate">
                                                    <div class="product-rating" style="width: 60%"></div>
                                                </div>
