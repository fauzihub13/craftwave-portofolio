                    ...
                    <div class="col-xl-8 col-lg-10 col-md-12 m-auto">
                        <div class="row">
                            <div class="col-lg-6 pr-30 d-none d-lg-block">
                                <img class="border-radius-15" src="{{ asset ('assets/toko-online/agrihub/assets/imgs/page/login-1.jpg') }}" alt="" />
                            </div>
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            ...
                                            <p class="mb-30">Don't have an account? <a href="{{ route('agrihub.page-register') }}">Create here</a></p>
                                        </div>
                                        <form method="post">
                                            ...
                                            <div class="login_footer form-group mb-50">
                                                ...
                                                <u><a href="{{ route('agrihub.page-forgot-password') }}" class="text-muted" href="#">Forgot password?</a></u>
                                            </div>
                                            <div class="form-group">
