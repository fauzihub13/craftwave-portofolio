        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="{{ route('agrihub.shop-product-full') }}">Vegetables & tubers</a> <span></span> Seeds of Change Organic
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                                        ...
                                        <div class="detail-gallery">
                                            ...
                                            <div class="product-image-slider">
                                                <figure class="border-radius-10">
                                                    <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/product-16-2.jpg') }}" alt="product image" />
                                                </figure>
                                                <figure class="border-radius-10">
                                                    <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/product-16-1.jpg') }}" alt="product image" />
                                                </figure>
                                                <figure class="border-radius-10">
                                                    <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/product-16-3.jpg') }}" alt="product image" />
                                                </figure>
                                                <figure class="border-radius-10">
                                                    <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/product-16-4.jpg') }}" alt="product image" />
                                                </figure>
                                                <figure class="border-radius-10">
                                                    <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/product-16-5.jpg') }}" alt="product image" />
                                                </figure>
                                                <figure class="border-radius-10">
                                                    <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/product-16-6.jpg') }}" alt="product image" />
                                                </figure>
                                                <figure class="border-radius-10">
                                                    <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/product-16-7.jpg') }}" alt="product image" />
                                                </figure>
                                            </div>
                                            <!-- THUMBNAILS -->
                                            <div class="slider-nav-thumbnails">
                                                <div><img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/thumbnail-3.jpg') }}" alt="product image" /></div>
                                                <div><img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/thumbnail-4.jpg') }}" alt="product image" /></div>
                                                <div><img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/thumbnail-5.jpg') }}" alt="product image" /></div>
                                                <div><img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/thumbnail-6.jpg') }}" alt="product image" /></div>
                                                <div><img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/thumbnail-7.jpg') }}" alt="product image" /></div>
                                                <div><img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/thumbnail-8.jpg') }}" alt="product image" /></div>
                                                <div><img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/thumbnail-9.jpg') }}" alt="product image" /></div>
                                            </div>
                                        </div>
                                        <!-- End Gallery -->
                                    </div>
                                        ...
                                        <div class="tab-content shop_info_tab entry-main-content">
                                            ...
                                            <div class="tab-pane fade" id="Vendor-info">
                                                <div class="vendor-logo d-flex mb-30">
                                                    <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/vendor/vendor-18.svg') }}" alt="" />
                                                    <div class="vendor-name ml-15">
                                                        <h6>
                                                            <a href="{{ route('agrihub.vendor-details-1') }}">Noodles Co.</a>
                                                        </h6>
                                                        <div class="product-rate-cover text-end">
                                                            <div class="product-rate d-inline-block">
                                                                <div class="product-rating" style="width: 90%"></div>
                                                ...
                                                <ul class="contact-infor mb-50">
                                                    <li><img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/theme/icons/icon-location.svg') }}" alt="" /><strong>Address: </strong> <span>5171 W Campbell Ave undefined Kent, Utah 53127 United States</span></li>
                                                    <li><img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/theme/icons/icon-contact.svg') }}" alt="" /><strong>Contact Seller:</strong><span>(+91) - 540-025-553</span></li>
                                                </ul>
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="comment-list">
                                                                <div class="single-comment justify-content-between d-flex mb-30">
                                                                    <div class="user justify-content-between d-flex">
                                                                        <div class="thumb text-center">
                                                                            <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/blog/author-2.png') }}" alt="" />
                                                                ...
                                                                <div class="single-comment justify-content-between d-flex mb-30 ml-30">
                                                                    <div class="user justify-content-between d-flex">
                                                                        <div class="thumb text-center">
                                                                            <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/blog/author-3.png') }}" alt="" />
                                                                ...
                                                                <div class="single-comment justify-content-between d-flex">
                                                                    <div class="user justify-content-between d-flex">
                                                                        <div class="thumb text-center">
                                                                            <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/blog/author-4.png') }}" alt="" />
                                        ...
                                        <div class="row related-products">
                                                ...
                                                <div class="product-cart-wrap hover-up">
                                                    <div class="product-img-action-wrap">
                                                        <div class="product-img product-img-zoom">
                                                            <a href="{{ route('agrihub.shop-product-full') }}" tabindex="0">
                                                    ...
                                                    <div class="product-content-wrap">
                                                        <h2><a href="{{ route('agrihub.shop-product-full') }}" tabindex="0">Ulstra Bass Headphone</a></h2>
                                            ...
                                            <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                                <div class="product-cart-wrap hover-up">
                                                    ...
                                                    <div class="product-content-wrap">
                                                        <h2><a href="{{ route('agrihub.shop-product-full') }}" tabindex="0">Smart Bluetooth Speaker</a></h2>
                                                        <div class="rating-result" title="90%">
                                                            <span> </span>
                                                        </div>
                                                        <div class="product-price">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                                <div class="product-cart-wrap hover-up">
                                                    ...
                                                    <div class="product-content-wrap">
                                                        <h2><a href="{{ route('agrihub.shop-product-full') }}" tabindex="0">HomeSpeak 12UEA Goole</a></h2>
                                                        <div class="rating-result" title="90%">
                                                            <span> </span>
                                                        </div>
                                                        <div class="product-price">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-12 col-sm-6 d-lg-block d-none">
                                                <div class="product-cart-wrap hover-up mb-0">
                                                    ...
                                                    <div class="product-content-wrap">
                                                        <h2><a href="{{ route('agrihub.shop-product-full') }}" tabindex="0">Dadua Camera 4K 2022EF</a></h2>
                                                        <div class="rating-result" title="90%">
                                                            <span> </span>
                                                        </div>
                                                        <div class="product-price">
                        ...
                        <div class="col-xl-3 primary-sidebar sticky-sidebar mt-30">
                            ...
                            <div class="sidebar-widget widget-vendor mb-30 bg-grey-9 box-shadow-none">
                                ...
                                <p>Become a Vendor? <a href="{{ route('agrihub.page-register') }}"> Register now</a></p>
                            </div>
                            <div class="sidebar-widget widget-category-2 mb-30">
                                <h5 class="section-title style-1 mb-30">Category</h5>
                                <ul>
                                    <li>
                                        <a href="{{ route('agrihub.shop-product-full') }}"> <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/theme/icons/category-1.svg') }}" alt="" />Milks & Dairies</a><span class="count">30</span>
                                    </li>
                                    <li>
                                        <a href="{{ route('agrihub.shop-product-full') }}"> <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/theme/icons/category-2.svg') }}" alt="" />Clothing</a><span class="count">35</span>
                                    </li>
                                    <li>
                                        <a href="{{ route('agrihub.shop-product-full') }}"> <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/theme/icons/category-3.svg') }}" alt="" />Pet Foods </a><span class="count">42</span>
                                    </li>
                                    <li>
                                        <a href="{{ route('agrihub.shop-product-full') }}"> <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/theme/icons/category-4.svg') }}" alt="" />Baking material</a><span class="count">68</span>
                                    </li>
                                    <li>
                                        <a href="{{ route('agrihub.shop-product-full') }}"> <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/theme/icons/category-5.svg') }}" alt="" />Fresh Fruit</a><span class="count">87</span>
                                    </li>
                                </ul>
                            </div>
                            <!-- Fillter By Price -->
                            ...
                            <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                                ...
                                <div class="single-post clearfix">
                                    <div class="image">
                                        <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/thumbnail-3.jpg') }}" alt="#" />
                                    </div>
                                    <div class="content pt-10">
                                        <h5><a href="{{ route('agrihub.shop-product-detail') }}">Chen Cardigan</a></h5>
                                ...
                                <div class="single-post clearfix">
                                    <div class="image">
                                        <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/thumbnail-4.jpg') }}" alt="#" />
                                    </div>
                                    <div class="content pt-10">
                                        <h6><a href="{{ route('agrihub.shop-product-detail') }}">Chen Sweater</a></h6>
                                ...
                                <div class="single-post clearfix">
                                    <div class="image">
                                        <img src="{{ asset ('assets/toko-online/agrihub/assets/imgs/shop/thumbnail-5.jpg') }}" alt="#" />
                                    </div>
                                    <div class="content pt-10">
                                        <h6><a href="{{ route('agrihub.shop-product-detail') }}">Colorful Jacket</a></h6>
