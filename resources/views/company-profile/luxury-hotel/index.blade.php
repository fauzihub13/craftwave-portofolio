...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(/assets/company-profile/luxury-hotel/images/big_image_1.jpg);">
      <div class="container">
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-12 text-center">
            ...
            <div class="mb-5 element-animate">
              ...
              <p><a href="{{ route('booknow') }}" class="btn btn-primary">Book Now</a></p>
            </div>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-7">
            <img src="{{ asset ('assets/company-profile/luxury-hotel/images/f_img_1.png') }}" alt="Image placeholder" class="img-md-fluid">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row ">
          ...
          <div class="col-md-5 room-thumbnail-absolute">
            <a href="#" class="media d-block room bg first-room" style="background-image: url(/assets/company-profile/luxury-hotel/images/img_2.jpg); ">
              <!-- <figure> -->
                <div class="overlap-text">
                  <span>
                    Hotel Room
            ...
            <a href="#" class="media d-block room bg second-room" style="background-image: url(/assets/company-profile/luxury-hotel/images/img_4.jpg); ">
              <!-- <figure> -->
                <div class="overlap-text">
                  <span>
                    Hotel Room
        ...
        <div class="row ">
          <div class="col-md-4">
            <div class="post-entry">
              <img src="{{ asset ('assets/company-profile/luxury-hotel/images/img_3.jpg') }}" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <img src="{{ asset ('assets/company-profile/luxury-hotel/images/img_6.jpg') }}" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <img src="{{ asset ('assets/company-profile/luxury-hotel/images/img_5.jpg') }}" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
