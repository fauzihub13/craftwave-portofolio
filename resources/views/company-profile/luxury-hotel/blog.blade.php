        ...
        <div class="row mb-5">
          <div class="col-md-4">
            <div class="post-entry">
              <a href="{{ route ('blog-single') }}"><img src="{{ asset ('/assets/company-profile/luxury-hotel/images/img_3.jpg') }}" alt="Image placeholder" class="img-fluid"></a>
              <div class="body-text">
                <div class="category">Rooms</div>
                <h3 class="mb-3"><a href="{{ route ('blog-single') }}">New Rooms</a></h3>
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <a href="{{ route ('blog-single') }}"><img src="{{ asset ('/assets/company-profile/luxury-hotel/images/img_6.jpg') }}" alt="Image placeholder" class="img-fluid"></a>
              <div class="body-text">
                <div class="category">News</div>
                <h3 class="mb-3"><a href="{{ route ('blog-single') }}">New Staff Added</a></h3>
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum deserunt illo quis similique dolore voluptatem culpa voluptas rerum, dolor totam.</p>
                <p><a href="#" class="btn btn-primary btn-outline-primary btn-sm">Read More</a></p>
              </div>
            </div>
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <a href="{{ route ('blog-single') }}"><img src="{{ asset ('/assets/company-profile/luxury-hotel/images/img_5.jpg') }}" alt="Image placeholder" class="img-fluid"></a>
              <div class="body-text">
                <div class="category">New Rooms</div>
                <h3 class="mb-3"><a href="{{ route ('blog-single') }}">Big Rooms for All</a></h3>
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum deserunt illo quis similique dolore voluptatem culpa voluptas rerum, dolor totam.</p>
                <p><a href="#" class="btn btn-primary btn-outline-primary btn-sm">Read More</a></p>
              </div>
            </div>
