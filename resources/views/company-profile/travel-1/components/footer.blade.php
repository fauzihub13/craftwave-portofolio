<footer class="cs_footer cs_style_1 cs_white_color cs_bg_filed cs_primary_bg" data-src="{{ asset('assets/company-profile/travel-1/assets/images/footer_bg.jpeg') }}">
      <div class="cs_newsletter_1_wrap">
        <div class="container-fluid">
          <div class="cs_newsletter cs_style_1 cs_accent_bg">
            <div class="cs_newsletter_icon"><img src="{{ asset('assets/company-profile/travel-1/assets/images/icons/envlop.png') }}" alt="Icon"></div>
        ...
        <div class="cs_footer_main">
          <div class="cs_footer_main_col">
            <div class="cs_footer_widget">
              <div class="cs_text_widget">
                <img src="{{ asset('assets/company-profile/travel-1/assets/images/footer_logo.svg') }}" alt="Logo">
              </div>
          ...
          <div class="cs_footer_main_col">
            <div class="cs_footer_widget">
              ...
              <ul class="cs_menu_widget">
                <li><a href="{{ route('travel-1.destination-details') }}">Emirates, United Arabian</a></li>
                <li><a href="{{ route('travel-1.destination-details') }}">Emirates, United Arabian</a></li>
                <li><a href="{{ route('travel-1.destination-details') }}">New York City, USA</a></li>
                <li><a href="{{ route('travel-1.destination-details') }}">New York City, USA</a></li>
                <li><a href="{{ route('travel-1.destination-details') }}">One Bridge, Belguim</a></li>
                <li><a href="{{ route('travel-1.destination-details') }}">One Bridge, Belguim</a></li>
                <li><a href="{{ route('travel-1.destination-details') }}">Golden Frame, Dubai</a></li>
                <li><a href="{{ route('travel-1.destination-details') }}">Golden Frame, Dubai</a></li>
              </ul>
            </div>
          </div>
