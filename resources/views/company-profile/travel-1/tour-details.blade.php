      ...
      <div class="row cs_gap_y_50">
        <div class="col-lg-8">
          <div class="cs_post_details">
            ...
            <img src="{{ asset('assets/company-profile/travel-1/assets/images/tour_details.jpeg') }}" alt="Tour Thumb">
            ...
            <div class="cs_tab_body">
              ...
              <div class="cs_tab" id="tab_3">
                <div class="cs_grid_3 cs_gallery_list cs_style_1">
                  <a href="{{ asset('assets/company-profile/travel-1/assets/images/gallery_1.jpeg') }}" class="cs_gallery_item cs_zoom">
                    <img src="{{ asset('assets/company-profile/travel-1/assets/images/gallery_1.jpeg') }}" alt="Gallery Image" class="cs_zoom_in">
                    <div class="cs_gallery_overlay"></div>
                    <div class="cs_gallery_icon position-absolute">
                      <img src="{{ asset('assets/company-profile/travel-1/assets/images/icons/plus_icon.svg') }}" alt="Icon">
                    </div>
                  </a>
                  <a href="{{ asset('assets/company-profile/travel-1/assets/images/gallery_2.jpeg') }}" class="cs_gallery_item cs_zoom">
                    <img src="{{ asset('assets/company-profile/travel-1/assets/images/gallery_2.jpeg') }}" alt="Gallery Image" class="cs_zoom_in">
                    <div class="cs_gallery_overlay"></div>
                    <div class="cs_gallery_icon position-absolute">
                      <img src="{{ asset('assets/company-profile/travel-1/assets/images/icons/plus_icon.svg') }}" alt="Icon">
                    </div>
                  </a>
                  <a href="{{ asset('assets/company-profile/travel-1/assets/images/gallery_3.jpeg') }}" class="cs_gallery_item cs_zoom">
                    <img src="{{ asset('assets/company-profile/travel-1/assets/images/gallery_3.jpeg') }}" alt="Gallery Image" class="cs_zoom_in">
                    <div class="cs_gallery_overlay"></div>
                    <div class="cs_gallery_icon position-absolute">
                      <img src="{{ asset('assets/company-profile/travel-1/assets/images/icons/plus_icon.svg') }}" alt="Icon">
                    </div>
                  </a>
                  <a href="{{ asset('assets/company-profile/travel-1/assets/images/gallery_4.jpeg') }}" class="cs_gallery_item cs_zoom">
                    <img src="{{ asset('assets/company-profile/travel-1/assets/images/gallery_4.jpeg') }}" alt="Gallery Image" class="cs_zoom_in">
                    <div class="cs_gallery_overlay"></div>
                    <div class="cs_gallery_icon position-absolute">
                      <img src="{{ asset('assets/company-profile/travel-1/assets/images/icons/plus_icon.svg') }}" alt="Icon">
                    </div>
                  </a>
                  <a href="{{ asset('assets/company-profile/travel-1/assets/images/gallery_5.jpeg') }}" class="cs_gallery_item cs_zoom">
                    <img src="{{ asset('assets/company-profile/travel-1/assets/images/gallery_5.jpeg') }}" alt="Gallery Image" class="cs_zoom_in">
                    <div class="cs_gallery_overlay"></div>
                    <div class="cs_gallery_icon position-absolute">
                      <img src="{{ asset('assets/company-profile/travel-1/assets/images/icons/plus_icon.svg') }}" alt="Icon">
                    </div>
                  </a>
                  <a href="{{ asset('assets/company-profile/travel-1/assets/images/gallery_6.jpeg') }}" class="cs_gallery_item cs_zoom">
                    <img src="{{ asset('assets/company-profile/travel-1/assets/images/gallery_6.jpeg') }}" alt="Gallery Image" class="cs_zoom_in">
                    <div class="cs_gallery_overlay"></div>
                    <div class="cs_gallery_icon position-absolute">
                      <img src="{{ asset('assets/company-profile/travel-1/assets/images/icons/plus_icon.svg') }}" alt="Icon">
                    </div>
          ...
          <div class="cs_tour_gallery">
            ...
            <div class="cs_gallery_img cs_radius_5">
              <img src="{{ asset('assets/company-profile/travel-1/assets/images/gallery_7.jpeg') }}" alt="Gallery Image">
            </div>
            <div class="cs_gallery_img cs_radius_5">
              <img src="{{ asset('assets/company-profile/travel-1/assets/images/gallery_8.jpeg') }}" alt="Gallery Image">
            </div>
            <div class="cs_gallery_img cs_radius_5">
              <img src="{{ asset('assets/company-profile/travel-1/assets/images/gallery_9.jpeg') }}" alt="Gallery Image">
            </div>
          </div>
          </div>
        </div>
