              ...
              <div class="sb-main-title-frame">
                <div class="sb-main-title">
                  ...
                  <ul class="sb-breadcrumbs">
                    ...
                    <li><a href="{{ route ('resto-1.contact') }}">Contact</a></li>
                  </ul>
                </div>
              </div>
              <!-- main title end -->
            ...
            <div class="col-lg-5">
              <div class="sb-contact-form-frame">
                <div class="sb-illustration-9">
                  <img src="{{ asset('assets/company-profile/resto-1/img/illustrations/envelope-1.png') }}" alt="envelope" class="sb-envelope-1">
                  <img src="{{ asset('assets/company-profile/resto-1/img/illustrations/envelope-2.png') }}" alt="envelope" class="sb-envelope-2">
