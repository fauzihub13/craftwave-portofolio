          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="sb-illustration-2 sb-mb-90">
                <div class="sb-interior-frame">
                  <img src="{{ asset('assets/company-profile/resto-1/img/img/gallery/2.jpg') }}" alt="interior" class="sb-interior" style="object-position: center">
                </div>
            ...
            <div class="col-lg-6 align-self-center sb-mb-60">
              ...
              <p class="sb-text sb-mb-60">Consectetur adipisicing elit. Cupiditate nesciunt amet facilis numquam, nam adipisci qui voluptate voluptas enim obcaecati veritatis animi nulla, mollitia commodi quaerat ex, autem ea
                laborum.</p>
              <img src="{{ asset('assets/company-profile/resto-1/img/ui/signature.png') }}" alt="Signature" class="sb-signature sb-mb-30">
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="sb-mb-90">
                ...
                <a data-fancybox="" data-no-swup href="https://www.youtube.com/watch?v=F3zw1Gvn4Mk" class="sb-btn">
                  <span class="sb-icon">
                    <img src="{{ asset('assets/company-profile/resto-1/img/ui/icons/play.svg') }}" alt="icon">
                  </span>
            ...
            <div class="col-lg-6 align-self-center">
              <div class="sb-illustration-7 sb-mb-90">
                <div class="sb-interior-frame">
                  <img src="{{ asset('assets/company-profile/resto-1/img/illustrations/interior-2.jpg') }}" alt="interior" class="sb-interior">
        ...
        <div class="container">
          <div class="sb-group-title sb-mb-30">
            ...
            <div class="sb-right sb-mb-30">
              <!-- button -->
              <a href="{{ route ('resto-1.menu') }}" class="sb-btn sb-m-0">
                <span class="sb-icon">
        ...
        <div class="container">
          <div class="sb-group-title sb-mb-30">
            ...
            <div class="sb-right sb-mb-30">
              ...
              <!-- button -->
              <a href="{{ route ('resto-1.reviews') }}" class="sb-btn">
                <span class="sb-icon">
                  <img src="{{ asset('assets/company-profile/resto-1/img/ui/icons/dialog.svg') }}" alt="icon">
                </span>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="sb-review-card">
                  ...
                  <div class="sb-author-frame">
                    <div class="sb-avatar-frame">
                      <img src="{{ asset('assets/company-profile/resto-1/img/faces/1.jpg') }}" alt="Guest">
                    </div>
                    <h4>Emma Newman</h4>
                  </div>
                </div>
              ...
              <div class="swiper-slide">
                <div class="sb-review-card">
                  ...
                  <div class="sb-author-frame">
                    <div class="sb-avatar-frame">
                      <img src="{{ asset('assets/company-profile/resto-1/img/faces/2.jpg') }}" alt="Guest">
                    </div>
                    <h4>Paul Trueman</h4>
                  </div>
                </div>
              ...
              <div class="swiper-slide">
                <div class="sb-review-card">
                  ...
                  <div class="sb-author-frame">
                    <div class="sb-avatar-frame">
                      <img src="{{ asset('assets/company-profile/resto-1/img/faces/3.jpg') }}" alt="Guest">
                    </div>
              ...
              <div class="swiper-slide">
                <div class="sb-review-card">
                  ...
                  <div class="sb-author-frame">
                    <div class="sb-avatar-frame">
                      <img src="{{ asset('assets/company-profile/resto-1/img/faces/4.jpg') }}" alt="Guest">
                    </div>
                    <h4>Audrey Oldman</h4>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="sb-cta-text">
                ...
                <a href="#" class="sb-btn">
                  <span class="sb-icon">
                    <img src="{{ asset('assets/company-profile/resto-1/img/ui/icons/cart.svg') }}" alt="icon">
                  </span>
                  <span>Order delivery</span>
                </a>
                <!-- button end -->
                <!-- button -->
                <a href="{{ route ('resto-1.menu') }}" class="sb-btn sb-btn-2 sb-btn-gray">
                  <span class="sb-icon">
                    <img src="{{ asset('assets/company-profile/resto-1/img/ui/icons/menu.svg') }}" alt="icon">
                  </span>
                  <span>Menu</span>
            ...
            <div class="col-lg-6">
              <div class="sb-illustration-8">
                <img src="{{ asset('assets/company-profile/resto-1/img/illustrations/delivery.png') }}" alt="reserved" class="sb-reserved">
                <div class="sb-cirkle-1"></div>
                <div class="sb-cirkle-2"></div>
                <div class="sb-cirkle-3"></div>
                <div class="sb-cirkle-4"></div>
                <div class="sb-cirkle-5"></div>
                <img src="{{ asset('assets/company-profile/resto-1/img/illustrations/2.svg') }}" alt="icon" class="sb-pik-2">
                <img src="{{ asset('assets/company-profile/resto-1/img/illustrations/3.svg') }}" alt="icon" class="sb-pik-3">
              </div>
            </div>
          </div>
        </div>
